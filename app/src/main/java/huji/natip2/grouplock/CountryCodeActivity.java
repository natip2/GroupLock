...
public class CountryCodeActivity extends ListActivity {
    public final static String RESULT_CUONTRY_CODE = "countrycode";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        populateCountryList();
        ArrayAdapter<Country> adapter = new huji.natip2.grouplock.CountryListArrayAdapter(this, countryList);
        ...
        getListView().setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                returnIntent.putExtra(RESULT_CUONTRY_CODE, c.getCode());
